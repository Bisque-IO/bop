...
MDBX_Env_Flags :: enum u32 {
    ...
    */
    ...
    @note Starting with v0.13, the `MDBX_NOSTICKYTHREADS` option completely
    ...
    */
    ...
    Using any combination of @ref MDBX_SAFE_NOSYNC, \ref MDBX_NOMETASYNC and
    especially @ref MDBX_UTTERLY_NOSYNC is always a deal to reduce durability
...
MDBX_Txn_Flags :: enum u32 {
    ...
    */
    ...
    @note Transaction state flag. Returned from @ref mdbx_txn_flags()
    ...
    */
    ...
    @note This is a transaction state flag. Returned from @ref mdbx_txn_flags()
    but can't be used with @ref mdbx_txn_begin().
    */
	Finished          = 0x01,
...
MDBX_Option :: enum i32 {
    ...
    By default only unnamed key-value table could used and
    ...
    */
    ...
    A long values requires allocation of contiguous database pages.
    ...
    */
    ...
    A 'dirty page' refers to a page that has been updated in memory
    ...
    */
	...
	/*
	Controls the in-process initial allocation size for dirty pages
    ...
    */
    ...
    The `MDBX_opt_spill_max_denominator` defines the denominator for
    ...
    */
    ...
    The `MDBX_opt_spill_min_denominator` defines the denominator for
    ...
    */
    ...
    The `MDBX_opt_spill_parent4child_denominator` defines the
    ...
    */
    ...
    This option controls the in-process threshold of minimum page
    ...
    */
    ...
    Depending on the operating system, storage subsystem
	...
	*
    @note MDBX_opt_writethrough_threshold affects only @ref MDBX_SYNC_DURABLE
    ...
    */
	...
	/*
	Specifies in % the minimum amount of free space on the main page, in the absence
...
MDBX_Env_Delete_Mode :: enum i32 {
    ...
    @note On Windows, the behavior of `MDBX_ENV_JUST_DELETE` is different
...
MDBX_Warmup_Flags :: enum i32 {
	...
	*/
	...
	@note Has effect only on POSIX (non-Windows) systems with conjunction
