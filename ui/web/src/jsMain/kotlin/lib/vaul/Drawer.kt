@file:JsModule("vaul") @file:JsNonModule
...
external interface DrawerTriggerProps : PropsWithChildren, PropsWithClassName, PropsWithStyle,
   PropsWithRef<HTMLElement> {
   var asChild: Boolean?
}

external interface DrawerOverlayProps : PropsWithChildren, PropsWithClassName, PropsWithStyle,
   PropsWithRef<HTMLElement> {
   var asChild: Boolean?
}

external interface DrawerContentProps : PropsWithChildren, PropsWithClassName, PropsWithStyle,
   PropsWithRef<HTMLElement> {
   var asChild: Boolean?
}
...
external interface DrawerDescriptionProps : PropsWithChildren, PropsWithClassName, PropsWithStyle,
   PropsWithRef<HTMLElement> {
   var asChild: Boolean?
}
