...
import lucide.XIcon
import radix.ui.DialogCloseProps
import radix.ui.DialogContentProps
import radix.ui.DialogDescriptionProps
import radix.ui.DialogOverlayProps
import radix.ui.DialogPortalProps
import radix.ui.DialogRootProps
import radix.ui.DialogTitleProps
import radix.ui.DialogTriggerProps
import react.FC
...
val DialogOverlay = FC<DialogOverlayProps>("DialogOverlay") { props ->
   radix.ui.DialogOverlay {
      ...
      className = cn("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80", props.className)
