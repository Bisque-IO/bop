...
// ------------------------------
// Toolbar Root
external interface ToolbarProps : RadixProps {
...
// ------------------------------
// Toolbar Button
external interface ToolbarButtonProps : RadixProps {
    var asChild: Boolean?
}
...
// ------------------------------
// Toolbar .Link
external interface ToolbarLinkProps : RadixProps {
    var asChild: Boolean?
}
...
// ------------------------------
// Toolbar Separator
external interface ToolbarSeparatorProps : RadixProps {
    var orientation: String? // "horizontal" | "vertical"
...
external interface ToolbarToggleGroupProps : RadixProps {
...
// ------------------------------
// Toolbar Toggle Item
external interface ToolbarToggleItemProps : RadixProps {
    var value: String
    var pressed: Boolean?
