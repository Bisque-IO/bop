...
// Root
// ------------------------------
external interface TabsRootProps : RadixProps {
...
// List
// ------------------------------
external interface TabsListProps : RadixProps {
    var asChild: Boolean?
...
// Trigger
// ------------------------------
external interface TabsTriggerProps : RadixProps {
    var value: String
    var asChild: Boolean?
...
// Content
// ------------------------------
external interface TabsContentProps : RadixProps {
    var value: String
    var asChild: Boolean?
