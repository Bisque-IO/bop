 ...
 * @see CollapsibleRoot
 */
external interface CollapsibleRootProps : DefaultProps, PropsWithAsChild {
   /**
 ...
 */
@JsName("Root")
external val CollapsibleRoot: ComponentType<CollapsibleRootProps>

/**
 * @see CollapsibleTrigger
 */
external interface CollapsibleTriggerProps : DefaultProps, PropsWithAsChild {
   @JsName("data-state")
   var dataState: String? // "open" | "closed"
 ...
 */
external interface CollapsibleContentProps : DefaultProps, PropsWithAsChild {
   /**
