 ...
 * @see ContextMenuRoot
 */
external interface ContextMenuRootProps : DefaultProps {
   /**
...
/**
 * @see ContextMenuTrigger
 */
external interface ContextMenuTriggerProps : DefaultProps, PropsWithAsChild {
   /**
...
/**
 * @see ContextMenuPortal
 */
external interface ContextMenuPortalProps : DefaultProps {
   /**
 ...
 *
 */
external interface ContextMenuContentProps : DefaultProps, PropsWithAsChild {
   /**
...
/**
 * @see ContextMenuArrow
 */
external interface ContextMenuArrowProps : DefaultProps, PropsWithAsChild {
   /**
 ...
 * @see ContextMenuItem
 */
external interface ContextMenuItemProps : DefaultProps, PropsWithAsChild {
   /**
...
/**
 * @see ContextMenuGroup
 */
external interface ContextMenuGroupProps : DefaultProps, PropsWithAsChild
...
/**
 * @see ContextMenuLabel
 */
external interface ContextMenuLabelProps : DefaultProps, PropsWithAsChild
...
/**
 * @see ContextMenuCheckboxItem
 */
external interface ContextMenuCheckboxItemProps : DefaultProps, PropsWithAsChild {
   /**
...
external interface ContextMenuRadioItemProps : DefaultProps, PropsWithAsChild, PropsWithValue<String> {
   /**
    * When true, prevents the user from interacting with the item.
    */
   var disabled: Boolean?
...
/**
 * @see ContextMenuItemIndicator
 */
external interface ContextMenuItemIndicatorProps : DefaultProps, PropsWithAsChild {
   /**
    * Used to force mounting when more control is needed. Useful when controlling
...
/**
 * @see ContextMenuSeparator
 */
external interface ContextMenuSeparatorProps : DefaultProps, PropsWithAsChild
...
/**
 * @see ContextMenuSubTrigger
 */
external interface ContextMenuSubTriggerProps : DefaultProps, PropsWithAsChild {
   /**
    * When true, prevents the user from interacting with the item.
    */
   var disabled: Boolean?
 ...
 */
external interface ContextMenuSubContentProps : DefaultProps, PropsWithAsChild {
   /**
    * When true, keyboard navigation will loop from last item to first, and vice versa.
    */
   var loop: Boolean?
