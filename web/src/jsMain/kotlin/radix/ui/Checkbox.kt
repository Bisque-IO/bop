...
// Root (Checkbox)
// ------------------------------
external interface CheckboxRootProps : DefaultProps, PropsWithAsChild {
   /**
 ...
 */
@JsName("Root")
external val CheckboxRoot: ComponentType<CheckboxRootProps>

/**
 * @see CheckboxIndicator
 */
external interface CheckboxIndicatorProps : DefaultProps, PropsWithAsChild {
   /**
