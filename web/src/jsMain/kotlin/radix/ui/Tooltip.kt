...
// Root
// ------------------------------
external interface TooltipRootProps : DefaultProps {
...
// Trigger
// ------------------------------
external interface TooltipTriggerProps : DefaultProps {
    var asChild: Boolean?
}
...
// Arrow
// ------------------------------
external interface TooltipArrowProps : DefaultProps {
    var width: Int?
    var height: Int?
    var asChild: Boolean?
}
...
// Provider
// ------------------------------
external interface TooltipProviderProps : DefaultProps {
