...
/**
 * @see HoverCardPrimitiveRoot
 */
external interface HoverCardRootProps : RadixProps {
    /**
 ...
 */
@JsName("Root")
external val HoverCardPrimitiveRoot: ComponentType<RadixProps>

/**
 * @see HoverCardPrimitiveTrigger
 */
external interface HoverCardTriggerProps : RadixProps, PropsWithAsChild {
    @JsName("data-state")
 ...
 */
@JsName("Trigger")
external val HoverCardPrimitiveTrigger: ComponentType<HoverCardTriggerProps>

/**
 * @see HoverCardPrimitivePortal
 */
external interface HoverCardPortalProps : RadixProps {
    /**
 ...
 */
@JsName("Portal")
external val HoverCardPrimitivePortal: ComponentType<HoverCardPortalProps>

/**
 * @see HoverCardPrimitiveContent
 */
external interface HoverCardContentProps : RadixProps, PropsWithAsChild {
    /**
     * Used to force mounting when more control is needed. Useful when controlling
 ...
 */
@JsName("Content")
external val HoverCardPrimitiveContent: ComponentType<HoverCardContentProps>

/**
 * @see HoverCardPrimitiveArrow
 */
external interface HoverCardArrowProps : RadixProps, PropsWithAsChild {
    /**
 ...
 */
@JsName("Arrow")
external val HoverCardPrimitiveArrow: ComponentType<HoverCardArrowProps>
