...
/**
 * Utility functions to help with using {@link AutoCloseable} resources. If a null exception is
 * passed then it is ignored.
 */
public final class CloseHelper {
  ...
  /**
   * Close a {@link AutoCloseable} dealing with nulls and exceptions. This version re-throws
  ...
  /**
   * Close all provided closeables. If any of them throw then throw that exception. If multiple
   * closeables throw an exception when being closed, then throw an exception that contains all of
   * them as suppressed exceptions.
   *
   * @param closeables to be closed.
   */
  ...
  public static void closeAll(
      final ErrorHandler errorHandler, final Collection<? extends AutoCloseable> closeables) {
    if (null != closeables) {
