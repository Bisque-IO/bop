...
/**
 * Layout of the broadcast buffer. The buffer consists of a ring of messages that is a power of 2 in
 * size. This is followed by a trailer section containing state information about the ring.
 */
