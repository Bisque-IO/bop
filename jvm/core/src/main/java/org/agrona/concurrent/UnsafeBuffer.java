...
/**
 * Supports regular, byte ordered, and atomic (memory ordered) access to an underlying buffer. The
 * buffer can be a byte[], one of the various {@link ByteBuffer} implementations, or an off Java
 * heap memory address.
 *
 * <p>{@link ByteOrder} of a wrapped buffer is not applied to the {@link UnsafeBuffer}.
 * {@link UnsafeBuffer}s are effectively stateless and can be used concurrently, the wrapping
 * methods are an exception. To control {@link ByteOrder} use the appropriate method with the
 * {@link ByteOrder} overload.
 *
 * <p><b>Note:</b> This class has a natural ordering that is inconsistent with equals. Types may be
 * different but equal on buffer contents.
 *
 * <p><b>Note:</b> The wrap methods on this class are not thread safe. Concurrent access should only
 * happen after a successful wrap.
 */
...
public class UnsafeBuffer extends AbstractMutableDirectBuffer implements AtomicBuffer {
   ...
   */
  public static final String DISABLE_BOUNDS_CHECKS_PROP_NAME =
      DirectBuffer.DISABLE_BOUNDS_CHECKS_PROP_NAME;
  ...
  /**
   * Attach a view to an off-heap memory region by address. This is useful for interacting with
   * native libraries.
   *
  ...
  public void verifyAlignment() {
    if (null != byteArray) {
      ...
      throw new IllegalStateException("AtomicBuffer is not correctly aligned: addressOffset="
          + addressOffset + " is not divisible by " + ALIGNMENT);
    }
  }
  ...
  public long getLongVolatile(final int index) {
    ...
    return UnsafeApi.U.getLongVolatile(byteArray, addressOffset + index);
  }
  ...
  public void putLongVolatile(final int index, final long value) {
    ...
    UnsafeApi.U.putLongVolatile(byteArray, addressOffset + index, value);
  }
  ...
  public long getLongAcquire(final int index) {
    ...
    return UnsafeApi.U.getLongAcquire(byteArray, addressOffset + index);
  }
  ...
  public void putLongRelease(final int index, final long value) {
    ...
    UnsafeApi.U.putLongRelease(byteArray, addressOffset + index, value);
  }
  ...
  public long addLongRelease(final int index, final long increment) {
    ...
    return UnsafeApi.U.getAndAddLongRelease(byteArray, addressOffset + index, increment);
  }
  ...
  public void putLongOpaque(final int index, final long value) {
    ...
    UnsafeApi.U.putLongOpaque(byteArray, addressOffset + index, value);
  }
  ...
  public long getLongOpaque(final int index) {
    ...
    return UnsafeApi.U.getLongOpaque(byteArray, addressOffset + index);
  }
  ...
  public long addLongOpaque(final int index, final long increment) {
    ...
    final long oldValue = UnsafeApi.U.getLongOpaque(byteArray, addressOffset + index);
    final long newValue = oldValue + increment;
    UnsafeApi.U.putLongOpaque(byteArray, addressOffset + index, newValue);
    return oldValue;
  }

  /** {@inheritDoc} */
  public boolean compareAndSetLong(
      final int index, final long expectedValue, final long updateValue) {
    if (SHOULD_BOUNDS_CHECK) {
      boundsCheck0(index, SIZE_OF_LONG);
    }

    return UnsafeApi.U.compareAndSetLong(
        byteArray, addressOffset + index, expectedValue, updateValue);
  }
  ...
  public long compareAndExchangeLong(
    ...
    return UnsafeApi.U.compareAndExchangeLong(
        byteArray, addressOffset + index, expectedValue, updateValue);
  }
  ...
  public long getAndSetLong(final int index, final long value) {
    ...
    return UnsafeApi.U.getAndSetLong(byteArray, addressOffset + index, value);
  }
  ...
  public long getAndAddLong(final int index, final long delta) {
    ...
    return UnsafeApi.U.getAndAddLong(byteArray, addressOffset + index, delta);
  }
  ...
  public int getIntVolatile(final int index) {
    ...
    return UnsafeApi.U.getIntVolatile(byteArray, addressOffset + index);
  }
  ...
  public void putIntVolatile(final int index, final int value) {
    ...
    UnsafeApi.U.putIntVolatile(byteArray, addressOffset + index, value);
  }
  ...
  public int getIntAcquire(final int index) {
    ...
    return UnsafeApi.U.getIntAcquire(byteArray, addressOffset + index);
  }
  ...
  public void putIntRelease(final int index, final int value) {
    ...
    UnsafeApi.U.putIntRelease(byteArray, addressOffset + index, value);
  }
  ...
  public int addIntRelease(final int index, final int increment) {
    ...
    return UnsafeApi.U.getAndAddIntRelease(byteArray, addressOffset + index, increment);
  }
  ...
  public void putIntOpaque(final int index, final int value) {
    ...
    UnsafeApi.U.putIntOpaque(byteArray, addressOffset + index, value);
  }
  ...
  public int getIntOpaque(final int index) {
    ...
    return UnsafeApi.U.getIntOpaque(byteArray, addressOffset + index);
  }
  ...
  public int addIntOpaque(final int index, final int increment) {
    ...
    final int oldValue = UnsafeApi.U.getIntOpaque(byteArray, addressOffset + index);
    final int newValue = oldValue + increment;
    UnsafeApi.U.putIntOpaque(byteArray, addressOffset + index, newValue);
    return oldValue;
  }
  ...
  public boolean compareAndSetInt(final int index, final int expectedValue, final int updateValue) {
    ...
    return UnsafeApi.U.compareAndSetInt(
        byteArray, addressOffset + index, expectedValue, updateValue);
  }

  /** {@inheritDoc} */
  public int compareAndExchangeInt(
      final int index, final int expectedValue, final int updateValue) {
    if (SHOULD_BOUNDS_CHECK) {
      boundsCheck0(index, SIZE_OF_INT);
    }

    return UnsafeApi.U.compareAndExchangeInt(
        byteArray, addressOffset + index, expectedValue, updateValue);
  }
  ...
  public int getAndSetInt(final int index, final int value) {
    ...
    return UnsafeApi.U.getAndSetInt(byteArray, addressOffset + index, value);
  }
  ...
  public int getAndAddInt(final int index, final int delta) {
    ...
    return UnsafeApi.U.getAndAddInt(byteArray, addressOffset + index, delta);
  }
  ...
  public short getShortVolatile(final int index) {
    ...
    return UnsafeApi.U.getShortVolatile(byteArray, addressOffset + index);
  }
  ...
  public void putShortVolatile(final int index, final short value) {
    ...
    UnsafeApi.U.putShortVolatile(byteArray, addressOffset + index, value);
  }
  ...
  public byte getByteVolatile(final int index) {
    ...
    return UnsafeApi.U.getByteVolatile(byteArray, addressOffset + index);
  }
  ...
  public void putByteVolatile(final int index, final byte value) {
    ...
    UnsafeApi.U.putByteVolatile(byteArray, addressOffset + index, value);
  }
  ...
  public char getCharVolatile(final int index) {
    ...
    return UnsafeApi.U.getCharVolatile(byteArray, addressOffset + index);
  }
  ...
  public void putCharVolatile(final int index, final char value) {
    ...
    UnsafeApi.U.putCharVolatile(byteArray, addressOffset + index, value);
  }

  /** {@inheritDoc} */
  public String toString() {
    return "UnsafeBuffer{" + "addressOffset="
        + addressOffset + ", capacity="
        + capacity + ", byteArray="
        + (null == byteArray ? "null" : ("byte[" + byteArray.length + "]")) + ", byteBuffer="
        + byteBuffer + '}';
  }
