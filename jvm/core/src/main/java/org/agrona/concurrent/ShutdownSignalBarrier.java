...
/**
 * One time barrier for blocking one or more threads until a SIGINT or SIGTERM signal is received
 * from the operating system or by programmatically calling {@link #signal()}. Useful for shutting
 * down a service.
 */
