...
/**
 * {@link org.agrona.concurrent.status.StatusIndicator} which wraps an {@link AtomicBuffer} with a
 * given counter id.
 *
 * @see org.agrona.concurrent.status.CountersManager
 */
public class UnsafeBufferStatusIndicator extends StatusIndicator {
  ...
  public String toString() {
    return "UnsafeBufferStatusIndicator{" + "counterId="
        + counterId + "value="
        + getVolatile() + '}';
  }
}
