...
public class Int2ObjectHashMap<V> implements Map<Integer, V> {
  ...
  /**
   * Constructs map with {@link #MIN_CAPACITY},
   * {@link org.agrona.collections.Hashing#DEFAULT_LOAD_FACTOR} and enables caching of iterators.
   */
  public Int2ObjectHashMap() {
    this(MIN_CAPACITY, org.agrona.collections.Hashing.DEFAULT_LOAD_FACTOR, true);
  }
  ...
  public V computeIfAbsent(
      final Integer key, final Function<? super Integer, ? extends V> mappingFunction) {
   ...
   * {@link IntFunction} and put it in the map.
   *
  ...
  public V computeIfPresent(
      final int key,
      final org.agrona.collections.IntObjectToObjectFunction<? super V, ? extends V>
          remappingFunction) {
