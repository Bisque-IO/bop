...
public class Long2ObjectHashMap<V> implements Map<Long, V> {
  ...
  /**
   * Constructs map with {@link #MIN_CAPACITY}, {@link Hashing#DEFAULT_LOAD_FACTOR} and enables
   ...
   */
  public Long2ObjectHashMap(@DoNotSub final int initialCapacity, final float loadFactor) {
  ...
  /**
   * Use {@link #forEachLong(LongObjConsumer)} instead.
   *
   * @param consumer a callback called for each key/value pair in the map.
   * @see #forEachLong(LongObjConsumer)
   * @deprecated Use {@link #forEachLong(LongObjConsumer)} instead.
   */
  @Deprecated
  public void longForEach(final LongObjConsumer<V> consumer) {
   ...
   * @param consumer a callback called for each key/value pair in the map.
   */
  public void forEachLong(final LongObjConsumer<V> consumer) {
   ...
   * {@link LongFunction} and put it in the map.
   *
   * <p>Primitive specialized version of {@link Map#computeIfAbsent(Object, Function)}.
   *
   ...
   *
   * <p>If the function returns {@code null}, the mapping is removed (or remains absent if initially
   * absent).
   *
  ...
  public void putAll(final Long2ObjectHashMap<? extends V> map) {
    final Long2ObjectHashMap<? extends V>.EntryIterator iterator =
  ...
  public final class ValueCollection extends AbstractCollection<V> {
    ...
    public void forEach(final Consumer<? super V> action) {
      @DoNotSub int remaining = Long2ObjectHashMap.this.size;
  ...
  public final class EntrySet extends AbstractSet<Entry<Long, V>> {
     ...
     * @return {@code true} if at least one key was removed.
     */
    public boolean removeIfLong(final LongObjPredicate<V> filter) {
      boolean removed = false;
