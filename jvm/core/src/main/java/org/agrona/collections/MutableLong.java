...
/**
 * Holder for a long value that is mutable. Useful for being a counter in a {@link java.util.Map} or
...
public class MutableLong extends Number implements Comparable<MutableLong> {
   ...
   * @return the value {@code 0} if {@code lhs == rhs}; a value less than {@code 0} if {@code lhs <
   *     rhs}; and a value greater than {@code 0} if {@code lhs > rhs}
   */
