...
/**
 * A fixed capacity cache of int keyed values that evicts the least-recently-used element when it
 * runs out of space.
 *
...
public final class IntLruCache<E> implements AutoCloseable {
   ...
   */
  public IntLruCache(
      @DoNotSub final int capacity, final IntFunction<E> factory, final Consumer<E> closer) {
