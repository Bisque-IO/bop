...
public class Env implements AutoCloseable {
  ...
  public Env(File path, long envAddress) {
    this.path = path;
    this.pathAddress = Memory.allocCString(path.getAbsolutePath());
  ...
  public int copy(String dst, int flags) {
    ...
    try {
      return (int) CFunctions.MDBX_ENV_COPY.invokeExact(envAddress, dstPtr, flags);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Stat stat() {
    ...
    int err;
    try {
      err = (int) CFunctions.MDBX_ENV_STAT_EX.invokeExact(envAddress, 0L, scratchPointer, 48L);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  ...
  public Info info() {
    ...
    try {
      err =
          (int) CFunctions.MDBX_ENV_INFO_EX.invokeExact(envAddress, 0L, scratchPointer, Info.SIZE);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
    if (err != Error.SUCCESS) {
  ...
  public int getFlags() {
    try {
      final var err = (int) CFunctions.MDBX_ENV_GET_FLAGS.invokeExact(envAddress, scratchPointer);
      if (err != Error.SUCCESS) {
        return Integer.MIN_VALUE;
      }
      return Danger.getInt(scratchPointer);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public int setFlags(final int flags, final boolean onoff) {
    try {
      return (int) CFunctions.MDBX_ENV_SET_FLAGS.invokeExact(envAddress, flags, onoff);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public long option(int option) {
    try {
      final var err =
          (int) CFunctions.MDBX_ENV_GET_OPTION.invokeExact(envAddress, option, scratchPointer);
      if (err != Error.SUCCESS) {
        return Long.MIN_VALUE;
      }
      return Danger.getLong(scratchPointer);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  /// @see Option
  /// returns A non-zero error value on failure and 0 on success.
  public int option(int option, long value) {
    try {
      return (int) CFunctions.MDBX_ENV_SET_OPTION.invokeExact(envAddress, option, value);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public int geometry(
    ...
    try {
      return (int) CFunctions.MDBX_ENV_SET_GEOMETRY.invokeExact(
          envAddress, sizeLower, sizeNow, sizeUpper, growthStep, shrinkThreshold, pageSize);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public long userCtx() {
    try {
      return (long) CFunctions.MDBX_ENV_GET_USERCTX.invokeExact(envAddress);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public int userCtx(long ctx) {
    try {
      return (int) CFunctions.MDBX_ENV_SET_USERCTX.invokeExact(envAddress, ctx);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public int openForRecovery(int targetMeta, boolean writeable) {
    try {
      return (int)
          CFunctions.MDBX_ENV_OPEN_FOR_RECOVERY.invokeExact(envAddress, targetMeta, writeable);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public int open(int flags, int mode) {
    try {
      return (int) CFunctions.MDBX_ENV_OPEN.invokeExact(envAddress, pathAddress, flags, mode);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
  ...
  /// \retval MDBX_EIO    An error occurred during the flushing/writing data
  ///                     to a storage medium/disk.
  public int doClose(boolean dontSync) {
    try {
      return (int) CFunctions.MDBX_ENV_CLOSE_EX.invokeExact(envAddress, dontSync);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    } finally {
      freeMemory();
  ...
  private void freeMemory() {
    ...
    final var pathPointer = this.pathAddress;
    if (pathPointer != 0L) {
  ...
  public int sync(boolean force, boolean nonblock) {
    try {
      return (int) CFunctions.MDBX_ENV_SYNC_EX.invokeExact(envAddress, force, nonblock);
    } catch (Throwable e) {
      throw new RuntimeException(e);
    }
  }
    ...
    try {
      ...
      try {
        err = (int) CFunctions.MDBX_TXN_BEGIN_EX.invokeExact(
            envAddress, parentPointer, flags, txnPointer, context);
      } catch (Throwable e) {
        throw new RuntimeException(e);
      }
      if (err != Error.SUCCESS) {
      ...
      txn.init(this, Danger.getLong(txnPointer), flags);
      return txn;
    } finally {
  ...
  public Txn begin(Txn parent, int flags) {
    return begin(parent, flags, 0L);
  }
  ...
  public static final class Info {
    ...
    void update(long ptr) {
      geo.lower = Danger.getLong(ptr);
      geo.upper = Danger.getLong(ptr + 8L);
      geo.current = Danger.getLong(ptr + 16L);
      geo.shrink = Danger.getLong(ptr + 24L);
      geo.grow = Danger.getLong(ptr + 32L);
      mapSize = Danger.getLong(ptr + 40L);
      lastPageNo = Danger.getLong(ptr + 48L);
      recentTxnId = Danger.getLong(ptr + 56L);
      latterReaderTxnId = Danger.getLong(ptr + 64L);
      selfLatterReaderTxnId = Danger.getLong(ptr + 72L);
      metaTxnID0 = Danger.getLong(ptr + 80L);
      metaTxnID1 = Danger.getLong(ptr + 88L);
      metaTxnID2 = Danger.getLong(ptr + 96L);
      metaSign0 = Danger.getLong(ptr + 104L);
      metaSign1 = Danger.getLong(ptr + 112L);
      metaSign2 = Danger.getLong(ptr + 120L);
      maxReaders = Danger.getInt(ptr + 128L);
      numReaders = Danger.getInt(ptr + 132L);
      dxbPageSize = Danger.getInt(ptr + 136L);
      sysPageSize = Danger.getInt(ptr + 140L);
      bootId.current.x = Danger.getLong(ptr + 144L);
      bootId.current.y = Danger.getLong(ptr + 152L);
      bootId.meta0.x = Danger.getLong(ptr + 160L);
      bootId.meta0.y = Danger.getLong(ptr + 168L);
      bootId.meta1.x = Danger.getLong(ptr + 176L);
      bootId.meta1.y = Danger.getLong(ptr + 184L);
      bootId.meta2.x = Danger.getLong(ptr + 192L);
      bootId.meta2.y = Danger.getLong(ptr + 200L);
      unsyncVolume = Danger.getLong(ptr + 208L);
      autoSyncThreshold = Danger.getLong(ptr + 216L);
      sinceSyncSeconds16dot16 = Danger.getInt(ptr + 224L);
      autoSyncPeriodSeconds16dot16 = Danger.getInt(ptr + 228L);
      sinceReaderCheckSeconds16dot16 = Danger.getInt(ptr + 232L);
      mode = Danger.getInt(ptr + 236L);
      pageOpStat.newly = Danger.getLong(ptr + 240L);
      pageOpStat.cow = Danger.getLong(ptr + 248L);
      pageOpStat.cloned = Danger.getLong(ptr + 256L);
      pageOpStat.split = Danger.getLong(ptr + 264L);
      pageOpStat.merge = Danger.getLong(ptr + 272L);
      pageOpStat.spill = Danger.getLong(ptr + 280L);
      pageOpStat.unspill = Danger.getLong(ptr + 288L);
      pageOpStat.wops = Danger.getLong(ptr + 296L);
      pageOpStat.prefault = Danger.getLong(ptr + 304L);
      pageOpStat.mincore = Danger.getLong(ptr + 312L);
      pageOpStat.msync = Danger.getLong(ptr + 320L);
      pageOpStat.fsync = Danger.getLong(ptr + 328L);
      dxbId.x = Danger.getLong(ptr + 336L);
      dxbId.y = Danger.getLong(ptr + 344L);
    }
  ...
  public static interface DebugFlags {
    int NONE = 0;
    int ASSERT = 1;
    int AUDIT = 2;
    int JITTER = 4;
  ...
  public static interface Constants {
    int MAX_DBI = 32765;
    long MAX_DATA_SIZE = 0x7fff0000;
    int MIN_PAGE_SIZE = 256;
    int MAX_PAGE_SIZE = 65536;
  }
}
