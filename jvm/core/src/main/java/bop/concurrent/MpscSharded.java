...
/// queue has no item available, but the size could be greater than zero if an offer is in progress.
...
/// provide sequential consistency across methods, but this can have a detrimental effect in
