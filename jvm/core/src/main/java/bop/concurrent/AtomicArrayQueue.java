...
abstract class AtomicArrayQueueProducer extends AbstractConcurrentArrayQueuePadding1 {
  /// Tail index.
  @Contended
...
@SuppressWarnings("unused")
abstract class AtomicArrayQueuePadding2 extends AtomicArrayQueueProducer {
  byte p064,
      p065,
      p066,
      p067,
...
abstract class AtomicArrayQueueConsumer extends AtomicArrayQueuePadding2 {
  /// Head index.
  @Contended
...
/// Pad out a cacheline between the producer and consumer fields to prevent false sharing.
@SuppressWarnings("unused")
abstract class AtomicArrayQueuePadding3 extends AtomicArrayQueueConsumer {
  byte p128,
      p129,
      p130,
      p131,
...
public abstract class AtomicArrayQueue<E> extends AtomicArrayQueuePadding3
    implements Queue<E> {
  ...
  static {
    try {
      ...
      TAIL_OFFSET =
          U.objectFieldOffset(AtomicArrayQueueProducer.class.getDeclaredField("tail"));
      SHARED_HEAD_CACHE_OFFSET = U.objectFieldOffset(
          AtomicArrayQueueProducer.class.getDeclaredField("sharedHeadCache"));
      HEAD_OFFSET =
          U.objectFieldOffset(AtomicArrayQueueConsumer.class.getDeclaredField("head"));
  ...
  public AtomicArrayQueue(final int requestedCapacity) {
  ...
  @SuppressWarnings("unchecked")
  public E peek() {
    return (E) U.getReferenceVolatile(buffer, sequenceToBufferOffset(head, capacity - 1));
  }
  ...
  public boolean contains(final Object o) {
    ...
    for (long i = head, limit = tail; i < limit; i++) {
      final Object e = U.getReferenceVolatile(buffer, sequenceToBufferOffset(i, mask));
      if (o.equals(e)) {
        return true;
      }
    }
