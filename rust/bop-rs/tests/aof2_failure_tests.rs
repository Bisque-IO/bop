...
use bop_rs::aof2::error::AofError;
use bop_rs::aof2::store::Tier2Config;
use bop_rs::aof2::store::Tier2Manager;
use bop_rs::aof2::store::tier2::{
...
fn tier2_fetch_retry_metrics() {
    ...
    rt.block_on(async {
        ...
        handle
            .schedule_fetch(bop_rs::aof2::store::tier2::Tier2FetchRequest {
                instance_id,
                segment_id,
                sealed_at: 0,
...
impl Tier2Client for ScriptedTier2Client {
    ...
    ) -> BoxFuture<'_, bop_rs::aof2::error::AofResult<PutObjectResult>> {
    ...
    ) -> BoxFuture<'_, bop_rs::aof2::error::AofResult<GetObjectResult>> {
    ...
    fn delete_object(
        ...
        _bucket: &str,
        _key: &str,
    ) -> BoxFuture<'_, bop_rs::aof2::error::AofResult<()>> {
    ...
    fn head_object(
        ...
        _bucket: &str,
        _key: &str,
    ) -> BoxFuture<'_, bop_rs::aof2::error::AofResult<Option<HeadObjectResult>>> {
