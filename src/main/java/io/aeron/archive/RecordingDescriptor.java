...
/**
 * Class that collects the parameters of the <code>RecordingDescriptor Consumer</code> callback for
 * use with the <code>RecordingDescriptorCollector</code>
 *
...
public class RecordingDescriptor {
  ...
  /// stopPosition reached for the recording, final position for [#position()].
  ///
  /// @return stopPosition
  ...
  /// initialTermId of the recorded stream, [#initialTermId()].
  ///
  ...
  /// termBufferLength of the recorded stream, [#termBufferLength()].
  ///
  ...
  /// mtuLength of the recorded stream, [#mtuLength()].
  ///
  /// @return mtuLength
  ...
  /// sessionId of the recorded stream, this will be the most recent session id for extended
  /// recordings.
  ///
  /// @return sessionId
  ...
  /// streamId of the recorded stream, [#streamId()].
  ///
  /// @return streamId
  public int streamId() {
    return streamId;
  ...
  /// strippedChannel of the recorded stream which is used for the recording subscription in the
  /// archive.
  ///
  ...
  /// sourceIdentity of the recorded stream, the [#sourceIdentity()].
  ///
