...
public final class SemanticVersion {
  ...
  /**
   * Compose a 4-byte integer with major, minor, and patch version stored in the least significant 3
   * bytes. The sum of the components must be greater than zero.
   *
  ...
  /**
   * Generate a {@link String} representation of the semantic version in the format
   * {@code major.minor.patch}.
   *
   * @param version to be converted to a string.
   * @return the {@link String} representation of the semantic version in the format
   *     {@code major.minor.patch}.
   */
