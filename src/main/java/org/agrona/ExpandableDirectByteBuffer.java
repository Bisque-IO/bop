...
/**
 * Expandable {@link MutableDirectBuffer} that is backed by a direct {@link ByteBuffer}. When values
 * are put into the buffer beyond its current length, then it will be expanded to accommodate the
 * resulting position for the value.
 *
 * <p>Put operations will expand the capacity as necessary up to {@link #MAX_BUFFER_LENGTH}. Get
 * operations will throw a {@link IndexOutOfBoundsException} if past current capacity.
 *
 * <p>{@link ByteOrder} of a wrapped buffer is not applied to the
 * {@link ExpandableDirectByteBuffer}; To control {@link ByteOrder} use the appropriate method with
 * the {@link ByteOrder} overload.
 *
...
public class ExpandableDirectByteBuffer extends AbstractMutableDirectBuffer {
  ...
  /**
   * Create an {@link ExpandableDirectByteBuffer} with an initial length of
   * {@link #INITIAL_CAPACITY}.
   */
  ...
  /** {@inheritDoc} */
  public void wrap(final org.agrona.DirectBuffer buffer) {
    throw new UnsupportedOperationException();
  }
  ...
  public String toString() {
    return "ExpandableDirectByteBuffer{" + "address="
