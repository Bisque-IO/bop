...
/** Common base class for implementing {@link org.agrona.MutableDirectBuffer} interface. */
public abstract class AbstractMutableDirectBuffer implements org.agrona.MutableDirectBuffer {
  ...
  public void setMemory(final int index, final int length, final byte value) {
    ...
    if (length < 100) {
      ...
      for (; i < end; i += 8) {
        org.agrona.UnsafeApi.U.putLong(array, offset + i, mask);
      }

      for (; i < length; i++) {
        org.agrona.UnsafeApi.U.putByte(array, offset + i, value);
      }
    } else {
      org.agrona.UnsafeApi.U.setMemory(array, offset, length, value);
    }
  }
  ...
  public long getLong(final int index, final ByteOrder byteOrder) {
    ...
    long bits = org.agrona.UnsafeApi.U.getLong(byteArray, addressOffset + index);
  ...
  public void putLong(final int index, final long value, final ByteOrder byteOrder) {
    ...
    org.agrona.UnsafeApi.U.putLong(byteArray, addressOffset + index, bits);
  }
  ...
  public long getLong(final int index) {
    ...
    return org.agrona.UnsafeApi.U.getLong(byteArray, addressOffset + index);
  }
  ...
  public void putLong(final int index, final long value) {
    ...
    org.agrona.UnsafeApi.U.putLong(byteArray, addressOffset + index, value);
  }
  ...
  public int getInt(final int index, final ByteOrder byteOrder) {
    ...
    int bits = org.agrona.UnsafeApi.U.getInt(byteArray, addressOffset + index);
    if (NATIVE_BYTE_ORDER != byteOrder) {
  ...
  public void putInt(final int index, final int value, final ByteOrder byteOrder) {
    ...
    org.agrona.UnsafeApi.U.putInt(byteArray, addressOffset + index, bits);
  }
  ...
  public int getInt(final int index) {
    ...
    return org.agrona.UnsafeApi.U.getInt(byteArray, addressOffset + index);
  }
  ...
  public void putInt(final int index, final int value) {
    ...
    org.agrona.UnsafeApi.U.putInt(byteArray, addressOffset + index, value);
  }
  ...
  public double getDouble(final int index, final ByteOrder byteOrder) {
    ...
    if (NATIVE_BYTE_ORDER != byteOrder) {
      final long bits = org.agrona.UnsafeApi.U.getLong(byteArray, addressOffset + index);
      return Double.longBitsToDouble(Long.reverseBytes(bits));
    } else {
      return org.agrona.UnsafeApi.U.getDouble(byteArray, addressOffset + index);
    }
  }
  ...
  public void putDouble(final int index, final double value, final ByteOrder byteOrder) {
    ...
    if (NATIVE_BYTE_ORDER != byteOrder) {
      ...
      org.agrona.UnsafeApi.U.putDouble(byteArray, addressOffset + index, value);
    }
  }
  ...
  public float getFloat(final int index, final ByteOrder byteOrder) {
    ...
    if (NATIVE_BYTE_ORDER != byteOrder) {
      final int bits = org.agrona.UnsafeApi.U.getInt(byteArray, addressOffset + index);
      return Float.intBitsToFloat(Integer.reverseBytes(bits));
    } else {
      return org.agrona.UnsafeApi.U.getFloat(byteArray, addressOffset + index);
    }
  }
  ...
  public void putFloat(final int index, final float value, final ByteOrder byteOrder) {
    ...
    if (NATIVE_BYTE_ORDER != byteOrder) {
      ...
      org.agrona.UnsafeApi.U.putFloat(byteArray, addressOffset + index, value);
    }
  }
  ...
  public short getShort(final int index, final ByteOrder byteOrder) {
    ...
    short bits = org.agrona.UnsafeApi.U.getShort(byteArray, addressOffset + index);
    if (NATIVE_BYTE_ORDER != byteOrder) {
  ...
  public void putShort(final int index, final short value, final ByteOrder byteOrder) {
    ...
    org.agrona.UnsafeApi.U.putShort(byteArray, addressOffset + index, bits);
  }
  ...
  public short getShort(final int index) {
    ...
    return org.agrona.UnsafeApi.U.getShort(byteArray, addressOffset + index);
  }
  ...
  public void putShort(final int index, final short value) {
    ...
    org.agrona.UnsafeApi.U.putShort(byteArray, addressOffset + index, value);
  }
  ...
  public byte getByte(final int index) {
    ...
    return org.agrona.UnsafeApi.U.getByte(byteArray, addressOffset + index);
  }
  ...
  public void putByte(final int index, final byte value) {
    ...
    org.agrona.UnsafeApi.U.putByte(byteArray, addressOffset + index, value);
  }
  ...
  public void getBytes(final int index, final byte[] dst) {
    if (SHOULD_BOUNDS_CHECK) {
      ...
      org.agrona.BufferUtil.boundsCheck(dst, 0, dst.length);
    }

    org.agrona.UnsafeApi.U.copyMemory(
        byteArray, addressOffset + index, dst, ARRAY_BASE_OFFSET, dst.length);
  }
  ...
  public void getBytes(final int index, final byte[] dst, final int offset, final int length) {
    if (SHOULD_BOUNDS_CHECK) {
      ...
      org.agrona.BufferUtil.boundsCheck(dst, offset, length);
    }

    org.agrona.UnsafeApi.U.copyMemory(
        byteArray, addressOffset + index, dst, ARRAY_BASE_OFFSET + offset, length);
  }

  /** {@inheritDoc} */
  public void getBytes(
      final int index, final MutableDirectBuffer dstBuffer, final int dstIndex, final int length) {
  ...
  /** {@inheritDoc} */
  public void getBytes(
      final int index, final ByteBuffer dstBuffer, final int dstOffset, final int length) {
    if (SHOULD_BOUNDS_CHECK) {
      boundsCheck0(index, length);
      org.agrona.BufferUtil.boundsCheck(dstBuffer, dstOffset, length);
    }
    ...
    if (dstBuffer.isDirect()) {
      ...
      dstByteArray = org.agrona.BufferUtil.array(dstBuffer);
      dstBaseOffset = ARRAY_BASE_OFFSET + arrayOffset(dstBuffer);
    }

    org.agrona.UnsafeApi.U.copyMemory(
        byteArray, addressOffset + index, dstByteArray, dstBaseOffset + dstOffset, length);
  }
  ...
  public void putBytes(final int index, final byte[] src) {
    ...
    org.agrona.UnsafeApi.U.copyMemory(
        src, ARRAY_BASE_OFFSET, byteArray, addressOffset + index, src.length);
  }
  ...
  public void putBytes(final int index, final byte[] src, final int offset, final int length) {
    ensureCapacity(index, length);
    if (SHOULD_BOUNDS_CHECK) {
      org.agrona.BufferUtil.boundsCheck(src, offset, length);
    }

    org.agrona.UnsafeApi.U.copyMemory(
        src, ARRAY_BASE_OFFSET + offset, byteArray, addressOffset + index, length);
  }
  ...
  public void putBytes(
      final int index, final ByteBuffer srcBuffer, final int srcIndex, final int length) {
    ensureCapacity(index, length);
    if (SHOULD_BOUNDS_CHECK) {
      org.agrona.BufferUtil.boundsCheck(srcBuffer, srcIndex, length);
    }
    ...
    org.agrona.UnsafeApi.U.copyMemory(
        srcByteArray, srcBaseOffset + srcIndex, byteArray, addressOffset + index, length);
  }

  /** {@inheritDoc} */
  public void putBytes(
      final int index,
      final org.agrona.DirectBuffer srcBuffer,
      final int srcIndex,
      final int length) {
    ensureCapacity(index, length);
    if (SHOULD_BOUNDS_CHECK) {
  ...
  public char getChar(final int index, final ByteOrder byteOrder) {
    ...
    char bits = org.agrona.UnsafeApi.U.getChar(byteArray, addressOffset + index);
    if (NATIVE_BYTE_ORDER != byteOrder) {
  ...
  public void putChar(final int index, final char value, final ByteOrder byteOrder) {
    ...
    org.agrona.UnsafeApi.U.putChar(byteArray, addressOffset + index, bits);
  }
  ...
  public char getChar(final int index) {
    ...
    return org.agrona.UnsafeApi.U.getChar(byteArray, addressOffset + index);
  }
  ...
  public void putChar(final int index, final char value) {
    ...
    org.agrona.UnsafeApi.U.putChar(byteArray, addressOffset + index, value);
  }
  ...
  public String getStringAscii(final int index) {
    ...
    final int length = org.agrona.UnsafeApi.U.getInt(byteArray, addressOffset + index);
    if (0 == length) {
      return "";
    }
  ...
  public int getStringAscii(
      final int index, final Appendable appendable, final ByteOrder byteOrder) {
    if (SHOULD_BOUNDS_CHECK) {
      boundsCheck0(index, STR_HEADER_LEN);
    }
  ...
  public String getStringAscii(final int index, final int length) {
    ...
    org.agrona.UnsafeApi.U.copyMemory(
        byteArray, addressOffset + index + STR_HEADER_LEN, dst, ARRAY_BASE_OFFSET, length);
  ...
  public int getStringAscii(final int index, final int length, final Appendable appendable) {
    ...
    try {
      ...
      for (int i = index + STR_HEADER_LEN, limit = index + STR_HEADER_LEN + length;
          i < limit;
          i++) {
        final char c = (char) org.agrona.UnsafeApi.U.getByte(array, offset + i);
        appendable.append(c > 127 ? '?' : c);
      }
    } catch (final IOException ex) {
      org.agrona.LangUtil.rethrowUnchecked(ex);
    }
  ...
  public int putStringAscii(final int index, final String value) {
    if (null == value) {
      ...
      org.agrona.UnsafeApi.U.putInt(byteArray, addressOffset + index, 0);
      ...
      final byte[] array = byteArray;
      final long offset = addressOffset + index;
      org.agrona.UnsafeApi.U.putInt(array, offset, length);
      ...
      for (int i = 0; i < length; i++) {
        ...
        org.agrona.UnsafeApi.U.putByte(array, offset + STR_HEADER_LEN + i, (byte) c);
      }
  ...
  public int putStringAscii(final int index, final String value, final ByteOrder byteOrder) {
    if (null == value) {
      ...
      final byte[] array = byteArray;
      final long offset = addressOffset + index;
      org.agrona.UnsafeApi.U.putInt(array, offset, lengthBits);
  ...
  public String getStringWithoutLengthAscii(final int index, final int length) {
    ...
    final byte[] dst = new byte[length];
    org.agrona.UnsafeApi.U.copyMemory(
        byteArray, addressOffset + index, dst, ARRAY_BASE_OFFSET, length);
  ...
  public int getStringWithoutLengthAscii(
      final int index, final int length, final Appendable appendable) {
    if (SHOULD_BOUNDS_CHECK) {
      boundsCheck0(index, length);
    }
  ...
  public int putStringWithoutLengthAscii(final int index, final String value) {
    ...
    for (int i = 0; i < length; i++) {
      ...
      org.agrona.UnsafeApi.U.putByte(array, offset + i, (byte) c);
    }
  ...
  public int putStringWithoutLengthAscii(
      final int index, final String value, final int valueOffset, final int length) {
    if (null == value) {
      return 0;
    }
  ...
  public String getStringUtf8(final int index, final int length) {
    ...
    org.agrona.UnsafeApi.U.copyMemory(
        byteArray,
        addressOffset + index + STR_HEADER_LEN,
        stringInBytes,
        ARRAY_BASE_OFFSET,
        length);
  ...
  public int putStringUtf8(final int index, final String value, final int maxEncodedLength) {
    ...
    if (bytes.length > maxEncodedLength) {
      throw new IllegalArgumentException(
          "Encoded string larger than maximum size: " + maxEncodedLength);
    }
    ...
    final byte[] array = byteArray;
    final long offset = addressOffset + index;
    org.agrona.UnsafeApi.U.putInt(array, offset, bytes.length);
    org.agrona.UnsafeApi.U.copyMemory(
        bytes, ARRAY_BASE_OFFSET, array, offset + STR_HEADER_LEN, bytes.length);
  ...
  public int putStringUtf8(
      final int index, final String value, final ByteOrder byteOrder, final int maxEncodedLength) {
    final byte[] bytes = value != null ? value.getBytes(UTF_8) : NULL_BYTES;
    if (bytes.length > maxEncodedLength) {
      throw new IllegalArgumentException(
          "Encoded string larger than maximum size: " + maxEncodedLength);
    ...
    final byte[] array = byteArray;
    final long offset = addressOffset + index;
    org.agrona.UnsafeApi.U.putInt(array, offset, bits);
    org.agrona.UnsafeApi.U.copyMemory(
        bytes, ARRAY_BASE_OFFSET, array, offset + STR_HEADER_LEN, bytes.length);
  ...
  public String getStringWithoutLengthUtf8(final int index, final int length) {
    ...
    final byte[] stringInBytes = new byte[length];
    org.agrona.UnsafeApi.U.copyMemory(
        byteArray, addressOffset + index, stringInBytes, ARRAY_BASE_OFFSET, length);
  ...
  public int putStringWithoutLengthUtf8(final int index, final String value) {
    ...
    org.agrona.UnsafeApi.U.copyMemory(
        bytes, ARRAY_BASE_OFFSET, byteArray, addressOffset + index, bytes.length);
  ...
  public int parseNaturalIntAscii(final int index, final int length) {
    ...
    if (length <= 0) {
      throw new org.agrona.AsciiNumberFormatException(
          "empty string: index=" + index + " length=" + length);
    }
  ...
  public long parseNaturalLongAscii(final int index, final int length) {
    ...
    if (length < LONG_MAX_DIGITS) {
      ...
      return parseLongAsciiOverflowCheck(
          index, length, LONG_MAX_VALUE_DIGITS, index, index + length);
    }
  }
  ...
  public int parseIntAscii(final int index, final int length) {
    ...
    final boolean negative =
        MINUS_SIGN == org.agrona.UnsafeApi.U.getByte(byteArray, addressOffset + index);
    int i = index;
    if (negative) {
      i++;
      if (1 == length) {
  ...
  public int putIntAscii(final int index, final int value) {
    ...
    if (value < 0) {
      ...
      org.agrona.UnsafeApi.U.putByte(array, offset, MINUS_SIGN);
      offset++;
    } else {
  ...
  public void putNaturalPaddedIntAscii(final int offset, final int length, final int value) {
    ...
    for (int index = end - 1; index >= offset; index--) {
      ...
      org.agrona.UnsafeApi.U.putByte(array, addressOffset + index, (byte) (ZERO + digit));
    }
  ...
  public boolean equals(final Object obj) {
    ...
    for (int end = length & ~7; i < end; i += 8) {
      if (org.agrona.UnsafeApi.U.getLong(thisArray, thisOffset + i)
          != org.agrona.UnsafeApi.U.getLong(thatArray, thatOffset + i)) {
        return false;
      }
    }

    for (; i < length; i++) {
      if (org.agrona.UnsafeApi.U.getByte(thisArray, thisOffset + i)
          != org.agrona.UnsafeApi.U.getByte(thatArray, thatOffset + i)) {
        return false;
      }
    }
  ...
  public int hashCode() {
    ...
    for (int end = length & ~7; i < end; i += 8) {
      hashCode =
          31 * hashCode + Long.hashCode(org.agrona.UnsafeApi.U.getLong(array, addressOffset + i));
    }

    for (; i < length; i++) {
      hashCode = 31 * hashCode + org.agrona.UnsafeApi.U.getByte(array, addressOffset + i);
    }
  ...
  public int compareTo(final DirectBuffer that) {
    ...
    for (int end = length & ~7; i < end; i += 8) {
      final int cmp = Long.compare(
          org.agrona.UnsafeApi.U.getLong(thisArray, thisOffset + i),
          org.agrona.UnsafeApi.U.getLong(thatArray, thatOffset + i));
    ...
    for (; i < length; i++) {
      final int cmp = Byte.compare(
          org.agrona.UnsafeApi.U.getByte(thisArray, thisOffset + i),
          org.agrona.UnsafeApi.U.getByte(thatArray, thatOffset + i));
  ...
  private int parsePositiveIntAscii(
    ...
    while ((end - i) >= 4
        && isFourDigitsAsciiEncodedNumber(
            quartet = org.agrona.UnsafeApi.U.getInt(array, offset + i))) {
    ...
    byte digit;
    while (i < end && isDigit(digit = org.agrona.UnsafeApi.U.getByte(array, offset + i))) {
  ...
  private long parsePositiveIntAsciiOverflowCheck(
    ...
    int i = startIndex;
    long tally = 0;
    long octet = org.agrona.UnsafeApi.U.getLong(array, offset + i);
  ...
  private void throwParseIntError(final int index, final int length) {
    throw new org.agrona.AsciiNumberFormatException(
        "error parsing int: " + getStringWithoutLengthAscii(index, length));
  }

  private void throwParseIntOverflowError(final int index, final int length) {
    throw new org.agrona.AsciiNumberFormatException(
        "int overflow parsing: " + getStringWithoutLengthAscii(index, length));
  }
  ...
  private long parsePositiveLongAscii(
    ...
    while ((end - i) >= 8
        && isEightDigitAsciiEncodedNumber(
            octet = org.agrona.UnsafeApi.U.getLong(array, offset + i))) {
      if (NATIVE_BYTE_ORDER != LITTLE_ENDIAN) {
        octet = Long.reverseBytes(octet);
      }
  ...
  private void throwParseLongError(final int index, final int length) {
    throw new org.agrona.AsciiNumberFormatException(
        "error parsing long: " + getStringWithoutLengthAscii(index, length));
  }

  private void throwParseLongOverflowError(final int index, final int length) {
    throw new AsciiNumberFormatException(
        "long overflow parsing: " + getStringWithoutLengthAscii(index, length));
  }

  private static void putPositiveIntAscii(
      final byte[] dest, final long offset, final int value, final int digitCount) {
    int i = digitCount;
    int quotient = value;
    while (quotient >= 10_000) {
      ...
      org.agrona.UnsafeApi.U.putByte(dest, offset + i, ASCII_DIGITS[p1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 1, ASCII_DIGITS[p1 + 1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 2, ASCII_DIGITS[p2]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 3, ASCII_DIGITS[p2 + 1]);
    }

    if (quotient >= 100) {
      final int position = (quotient % 100) << 1;
      quotient /= 100;
      org.agrona.UnsafeApi.U.putByte(dest, offset + i - 1, ASCII_DIGITS[position + 1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i - 2, ASCII_DIGITS[position]);
    }

    if (quotient >= 10) {
      final int position = quotient << 1;
      org.agrona.UnsafeApi.U.putByte(dest, offset + 1, ASCII_DIGITS[position + 1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset, ASCII_DIGITS[position]);
    } else {
      org.agrona.UnsafeApi.U.putByte(dest, offset, (byte) (ZERO + quotient));
    }
  }
  ...
  private static void putPositiveLongAscii(
    ...
    while (quotient >= 100_000_000) {
      ...
      org.agrona.UnsafeApi.U.putByte(dest, offset + i, ASCII_DIGITS[u1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 1, ASCII_DIGITS[u1 + 1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 2, ASCII_DIGITS[u2]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 3, ASCII_DIGITS[u2 + 1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 4, ASCII_DIGITS[l1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 5, ASCII_DIGITS[l1 + 1]);
      org.agrona.UnsafeApi.U.putByte(dest, offset + i + 6, ASCII_DIGITS[l2]);
      UnsafeApi.U.putByte(dest, offset + i + 7, ASCII_DIGITS[l2 + 1]);
    }
