 ...
 *
 * <p>If the period is zero or negative, no sleeping is done.
 *
 * <p>This class uses {@link LockSupport#parkNanos(long)} to idle.
 */
public final class SleepingIdleStrategy implements IdleStrategy {
   ...
   *
   * @param sleepPeriodNs period in nanosecond for which the strategy will sleep when work count is
   *     0.
   */
  ...
  public String toString() {
    return "SleepingIdleStrategy{" + "alias=" + ALIAS + ", sleepPeriodNs=" + sleepPeriodNs + '}';
  }
}
