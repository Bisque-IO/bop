...
/**
 * One producer to one consumer concurrent queue that is array backed. The algorithm is a variation
 * of Fast Flow adapted to work with the Java Memory Model on arrays by using
...
public class OneToOneConcurrentArrayQueue<E> extends AbstractConcurrentArrayQueue<E> {
  ...
  public boolean offer(final E e) {
    ...
    UnsafeApi.U.putReferenceRelease(buffer, elementOffset, e);
    UnsafeApi.U.putLongRelease(this, TAIL_OFFSET, currentTail + 1);
