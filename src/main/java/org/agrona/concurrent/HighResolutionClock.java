 ...
 *
 * <p>This implementation may be replaced on some platforms for greater performance.
 *
 * <p><b>Note:</b> The actual provided resolution may be a higher granularity than the possible
 * precision. For example, on Java 8 many JVMs will only advance a millisecond per tick so when
 * requesting micros or nanos then the returned time may be a multiple of milliseconds. Later JVMs
 * tend to improve on this.
 */
public final class HighResolutionClock {
   ...
   *
   * <p>Precision depends upon the JVM version used. Hotspot/OpenJDK 8 provides millisecond level
   * precision, 11 provides microsecond or lower granularity.
   *
