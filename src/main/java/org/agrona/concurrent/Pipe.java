...
public interface Pipe<E> {
   ...
   *
   * <p>If possible, implementations should use smart batching to best handle burst traffic.
   *
  ...
  /**
   * Drain the minimum of a limit and the number of elements present in a collection at the time the
   * operation starts.
   *
   * <p>If possible, implementations should use smart batching to best handle burst traffic.
   *
