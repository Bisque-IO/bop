...
public class CompositeAgent implements Agent {
   ...
   *
   * @param agents the parts of this composite, at least one agent and no null agents allowed
   * @throws IllegalArgumentException if an empty array of agents is provided, or single agent
   *     provided
   * @throws NullPointerException if the array or any element is null
   */
   ...
   * {@inheritDoc}
   *
   * <p>Note that one agent throwing an exception on start will not prevent other agents from being
   * started.
   *
   * @throws RuntimeException if any sub-agent throws an exception onStart. The agents exceptions
