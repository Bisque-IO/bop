...
public interface ControlledMessageHandler {
  ...
  enum Action {
    ...
    /**
     * Break from the current read operation and commit the position as of the end of the current
     * message being handled.
     */
    BREAK,

    /**
     * Continue processing but commit the position as of the end of the current message so that flow
     * control is applied to this point.
     */
    COMMIT,
