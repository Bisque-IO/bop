...
/**
 * {@link org.agrona.generation.OutputManager} for managing the creation of Java source files as the
 * target of code generation. The character encoding for the {@link Writer} is UTF-8.
 */
public class PackageOutputManager implements org.agrona.generation.OutputManager {
   ...
   *
   * <p>The {@link Writer} should be closed once the caller has finished with it. The Writer is
