  ...
  public static final class TargetName {
    ...
    static String resolveFilename(final String arch, final String os) {
      ...
      if (resolvedOs.equals("windows")) {
        return pkg + "/bop-" + resolvedArch + "-" + resolvedOs + "." + resolvedExtension;
      } else {
        return pkg + "/libbop-" + resolvedArch + "-" + resolvedOs + "." + resolvedExtension;
      }
    }
    ...
    private static String resolveOs(final String os) {
      if (check(os, "Linux", "linux")) {
        return "linux";
      } else if (check(
          os, "Mac OS", "macOS", "OSX", "Mac OS X", "mac", "darwin", "Mac", "Darwin")) {
        return "macos";
      } else if (check(os, "Windows", "win", "windows", "Windows NT")) {
        return "windows";
      }
