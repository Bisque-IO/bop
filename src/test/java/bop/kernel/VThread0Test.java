...
public class VThread0Test {
  ...
  static {
    try {
      ...
      var offset = Danger.UNSAFE.objectFieldOffset(virtualThreadClass, "cont");
      CONT_OFFSET = offset;
    ...
    try {
      ...
      LAMBDA_ARG1_OFFSET = Danger.UNSAFE.objectFieldOffset(arg1field);
  ...
  public static Thread newVirtualThread(
    ...
    try {
      ...
      try {
        var runContinuation = VIRTUAL_THREAD_RUN_CONTINUATION.invoke(thread);
        var arg1 = Danger.UNSAFE.getReference(runContinuation, LAMBDA_ARG1_OFFSET);
