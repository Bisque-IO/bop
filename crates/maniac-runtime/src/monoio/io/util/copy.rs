...
use crate::monoio::io::{AsyncReadRent, AsyncWriteRent, AsyncWriteRentExt};
#[cfg(unix)]
use crate::monoio::net::unix::new_pipe;
...
pub async fn zero_copy<SRC: crate::monoio::io::as_fd::AsReadFd, DST: crate::monoio::io::as_fd::AsWriteFd>(
    reader: &mut SRC,
    writer: &mut DST,
) -> io::Result<u64> {
    use crate::monoio::{
