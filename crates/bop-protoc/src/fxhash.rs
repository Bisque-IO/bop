...
pub fn hash_u32_32(value: u32) -> u32 {
    value.wrapping_mul(SEED32)
}

pub fn hash_u64_32(value: u64) -> u32 {
    (value as u32).wrapping_mul(SEED32).rotate_left(ROTATE).bitxor((value >> 32) as u32).wrapping_mul(SEED32)
}

pub fn hash_u64_64(value: u64) -> u64 {
    value.wrapping_mul(SEED64)
}

#[inline(always)]
fn read_u16(b: &[u8]) -> u16 {
    unsafe { u16::from_le(std::ptr::read_unaligned(core::ptr::addr_of!(b[0]) as *const u16)) }
}

#[inline(always)]
fn read_u32(b: &[u8]) -> u32 {
    unsafe { u32::from_le(std::ptr::read_unaligned(core::ptr::addr_of!(b[0]) as *const u32)) }
}

#[inline(always)]
fn read_u64(b: &[u8]) -> u64 {
    // u64::from_le(unsafe { *(b as *const u64) })
    unsafe { u64::from_le(std::ptr::read_unaligned(core::ptr::addr_of!(b[0]) as *const u64)) }
}
