use crate::raft::ManiacRuntime;
use maniac_raft::AppData;
use maniac_raft::AppDataResponse;
use maniac_raft::RaftTypeConfig;
use maniac_raft::impls::BasicNode;
use maniac_raft::impls::Entry;
use maniac_raft::impls::OneshotResponder;
use maniac_raft::impls::Vote;
use maniac_raft::impls::leader_id_adv::LeaderId;
use std::io::Cursor;
    ...
    R: AppDataResponse,
{
    ...
    type Responder<T: maniac_raft::OptionalSend + 'static> = OneshotResponder<Self, T>;
