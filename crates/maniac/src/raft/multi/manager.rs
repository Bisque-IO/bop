...
use crate::raft::multi::network::GroupNetworkFactory;
use crate::raft::multi::network::MultiRaftNetworkFactory;
...
use maniac_raft::storage::RaftStateMachine;
    ...
    S: MultiRaftLogStorage<C>,
{
    ...
    pub async fn add_group<SM>(
        ...
        state_machine: SM,
    ) -> Result<Raft<C>, maniac_raft::error::Fatal<C>>
    where
        C::SnapshotData: AsyncReadRent + AsyncWriteRent + Unpin,
        C::Entry: Clone,
