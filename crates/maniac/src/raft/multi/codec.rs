...
impl<C> ToCodec<LeaderId> for maniac_raft::impls::leader_id_adv::LeaderId<C>
where
...
impl<C> FromCodec<LeaderId> for maniac_raft::impls::leader_id_adv::LeaderId<C>
where
    C: RaftTypeConfig<NodeId = u64, Term = u64>,
{
...
impl<C> ToCodec<LogId> for maniac_raft::LogId<C>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
...
impl<C> FromCodec<LogId> for maniac_raft::LogId<C>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
        ...
        >,
{
    fn from_codec(codec: LogId) -> Self {
        Self {
            leader_id: maniac_raft::impls::leader_id_adv::LeaderId::<C> {
...
impl<C> ToCodec<Vote> for maniac_raft::impls::Vote<C>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
...
impl<C> FromCodec<Vote> for maniac_raft::impls::Vote<C>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
...
impl ToCodec<BasicNode> for maniac_raft::impls::BasicNode {
...
impl FromCodec<BasicNode> for maniac_raft::impls::BasicNode {
...
pub fn serialize_vote<C>(vote: &maniac_raft::impls::Vote<C>) -> Result<Vec<u8>, CodecError>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
...
pub fn deserialize_vote<C>(data: &[u8]) -> Result<maniac_raft::impls::Vote<C>, CodecError>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
        ...
        >,
{
    ...
    Ok(maniac_raft::impls::Vote::<C>::from_codec(codec_vote))
}

/// Serialize a LogId using zero-copy codec
pub fn serialize_log_id<C>(log_id: &maniac_raft::LogId<C>) -> Result<Vec<u8>, CodecError>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
...
pub fn deserialize_log_id<C>(data: &[u8]) -> Result<maniac_raft::LogId<C>, CodecError>
where
    C: RaftTypeConfig<
            NodeId = u64,
            Term = u64,
        ...
        >,
{
    ...
    Ok(maniac_raft::LogId::<C>::from_codec(codec_log_id))
}
