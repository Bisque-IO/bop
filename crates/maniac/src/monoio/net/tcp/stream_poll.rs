...
impl crate::monoio::io::IntoPollIo for TcpStream {
...
impl crate::monoio::io::IntoCompIo for TcpStreamPoll {
...
impl tokio::io::AsyncWrite for TcpStreamPoll {
    ...
    fn poll_write_vectored(
        ...
        unsafe {
            let raw_buf = crate::monoio::buf::RawBufVectored::new(bufs.as_ptr() as _, bufs.len());
