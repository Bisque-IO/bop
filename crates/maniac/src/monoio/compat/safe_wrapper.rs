...
use super::{box_future::MaybeArmedBoxFuture, buf::Buf};
...
impl<T: AsyncReadRent + Unpin + 'static> super::tokio_wrapper::AsyncRead for StreamWrapper<T> {
    fn poll_read(
        self: std::pin::Pin<&mut Self>,
        cx: &mut std::task::Context<'_>,
        buf: &mut super::tokio_wrapper::ReadBuf<'_>,
...
impl<T: AsyncWriteRent + Unpin + 'static> super::tokio_wrapper::AsyncWrite for StreamWrapper<T> {
    fn poll_write(
        self: std::pin::Pin<&mut Self>,
        cx: &mut std::task::Context<'_>,
        buf: &[u8],
