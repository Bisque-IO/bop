...
//
// use maniac::mpmc::Mpmc;
// use maniac::selector::Selector;
// use std::sync::Arc;
...
//
//     bulk_drain_multi_mpmc_blocking_benchmark::<8, 9>(4, 10_000_000, 1, 8192);
//     bulk_drain_multi_moody_blocking_benchmark::<8, 10>(4, 10_000_000, 1, 8192);
