...
public interface MessageFlyweight extends Flyweight {
  ...
  /**
   * The semantic type of the message which is typically the semantic equivalent in the FIX
   * repository.
   *
   * @return the semantic type of the message which is typically the semantic equivalent in the FIX
   *     repository.
   */
