...
public interface MessageDecoderFlyweight extends MessageFlyweight, DecoderFlyweight {
   ...
   */
  MessageDecoderFlyweight wrap(
      DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion);
  ...
  /**
   * Gets the total length of this flyweight by moving from the end of the block though all the
