...
/**
 * A thread safe extension of {@link CountersManager} which allows intra-process read and write
 * access to the same counters buffer. Note that inter-process access is not catered for.
 */
public class ConcurrentCountersManager extends CountersManager {
  ...
  public ConcurrentCountersManager(
      final AtomicBuffer metaDataBuffer, final AtomicBuffer valuesBuffer) {
