...
public class ObjectHashSet<T> extends AbstractSet<T> {
   ...
   * {@link org.agrona.collections.Hashing#DEFAULT_LOAD_FACTOR}, and iterator caching support.
   */
  ...
  public ObjectHashSet(final int proposedCapacity) {
    this(proposedCapacity, org.agrona.collections.Hashing.DEFAULT_LOAD_FACTOR);
  }
  ...
  public boolean add(final T value) {
    ...
    int index = org.agrona.collections.Hashing.hash(value.hashCode(), mask);
  ...
  private void rehash(final int newCapacity) {
    ...
    for (final T value : values) {
      if (value != MISSING_VALUE) {
        int newHash = org.agrona.collections.Hashing.hash(value.hashCode(), mask);
  ...
  void compactChain(int deleteIndex) {
    ...
    while (true) {
      ...
      final int hash = org.agrona.collections.Hashing.hash(values[index].hashCode(), mask);
