...
/**
 * A cache implementation specialised for int keys using open addressing to probe a set of fixed
 * size.
 *
...
public class Int2ObjectCache<V> implements Map<Integer, V> {
  ...
  public boolean containsKey(final int key) {
    boolean found = false;
    @DoNotSub final int setNumber = org.agrona.collections.Hashing.hash(key, mask);
