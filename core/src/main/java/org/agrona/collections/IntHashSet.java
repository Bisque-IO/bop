 ...
 * expanded.
 *
 * <p>By storing elements as int primitives this significantly reduces memory consumption compared
 * with Java's builtin <code>HashSet&lt;Integer&gt;</code>. It implements <code>Set&lt;Integer&gt;
 * </code> for convenience, but calling functionality via those methods can add boxing overhead to
 * your usage.
 *
