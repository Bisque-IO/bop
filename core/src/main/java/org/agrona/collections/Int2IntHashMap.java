...
public class Int2IntHashMap implements Map<Integer, Integer> {
  ...
  public int get(final int key) {
    ...
    @DoNotSub int index = org.agrona.collections.Hashing.evenHash(key, mask);
  ...
  private void rehash(@DoNotSub final int newCapacity) {
    ...
    for (@DoNotSub int valueIndex = 1; valueIndex < length; valueIndex += 2) {
      ...
      if (missingValue != value) {
        ...
        @DoNotSub int newKeyIndex = org.agrona.collections.Hashing.evenHash(key, mask);
  ...
  /**
   * Use {@link #forEachInt(org.agrona.collections.IntIntConsumer)} instead.
   *
   * @param consumer a callback called for each key/value pair in the map.
   * @see #forEachInt(org.agrona.collections.IntIntConsumer)
   * @deprecated Use {@link #forEachInt(org.agrona.collections.IntIntConsumer)} instead.
   */
  @Deprecated
  public void intForEach(final org.agrona.collections.IntIntConsumer consumer) {
    forEachInt(consumer);
  }
  ...
  public void replaceAll(
      final BiFunction<? super Integer, ? super Integer, ? extends Integer> function) {
  ...
  public int remove(final int key) {
    ...
    final int[] entries = this.entries;
    @DoNotSub final int mask = entries.length - 1;
    @DoNotSub int keyIndex = org.agrona.collections.Hashing.evenHash(key, mask);
  ...
  private void compactChain(@DoNotSub int deleteKeyIndex) {
    ...
    while (true) {
      ...
      @DoNotSub final int hash = org.agrona.collections.Hashing.evenHash(key, mask);
