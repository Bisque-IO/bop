...
/** View over a {@link org.agrona.DirectBuffer} which contains an ASCII string for a given range. */
public class AsciiSequenceView implements CharSequence {
  ...
  /**
   * Construct a view over a {@link org.agrona.DirectBuffer} from an offset for a given length.
   *
