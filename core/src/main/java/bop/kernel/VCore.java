...
public class VCore {
  ...
  private static final Unsafe U = Danger.ZONE;
  ...
  /// onBackground is called periodically from a different thread than
  /// the thread that called resume if resume is in progress. This provides
  /// a mechanism for dealing with resume being blocked for too long.
