...
public class Interned {
  ...
  public static Value get(String value) {
    return get(Hash.xxh3(value), value);
  }
  ...
  public static final class Value {
    ...
    public static Value of(String value) {
      final var xx3 = Hash.xxh3(value);
      final var bytes = value.getBytes(StandardCharsets.UTF_8);
      final var address = Danger.allocateMemory(bytes.length);
      Danger.copyMemory(bytes, Danger.BYTE_BASE, null, address, bytes.length);
